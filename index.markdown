...
Tales Imbiriba is an Assistant Professor in the Department of Computer Science (CS) at the University of Massachusetts Boston (UMB), Boston, MA, USA. Prior to joining UMB, Tales served as
...
![TMAP](/figs/SU.png){: width="210" : style="float: right" } 
